...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260726142501_AddJoppostsTables")]
    partial class AddJoppostsTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 14, 24, 56, 276, DateTimeKind.Utc).AddTicks(219),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 14, 24, 56, 276, DateTimeKind.Utc).AddTicks(230),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 14, 24, 56, 276, DateTimeKind.Utc).AddTicks(241),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
