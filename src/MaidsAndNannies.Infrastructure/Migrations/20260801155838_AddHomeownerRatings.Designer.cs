...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260801155838_AddHomeownerRatings")]
    partial class AddHomeownerRatings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 15, 58, 33, 904, DateTimeKind.Utc).AddTicks(6562),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 15, 58, 33, 904, DateTimeKind.Utc).AddTicks(6568),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 15, 58, 33, 904, DateTimeKind.Utc).AddTicks(6573),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
