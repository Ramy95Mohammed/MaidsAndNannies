...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260729131034_AddBookingIdInSubscriptionTable")]
    partial class AddBookingIdInSubscriptionTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 29, 13, 10, 30, 358, DateTimeKind.Utc).AddTicks(5943),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 29, 13, 10, 30, 358, DateTimeKind.Utc).AddTicks(5951),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 29, 13, 10, 30, 358, DateTimeKind.Utc).AddTicks(5956),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
