...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260807132541_MakeNationalIdNumberColumnNullInWorkerProfileTable_2")]
    partial class MakeNationalIdNumberColumnNullInWorkerProfileTable_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 8, 7, 13, 25, 40, 806, DateTimeKind.Utc).AddTicks(8535),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 8, 7, 13, 25, 40, 806, DateTimeKind.Utc).AddTicks(8542),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 8, 7, 13, 25, 40, 806, DateTimeKind.Utc).AddTicks(8547),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
