...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260731132806_AddPaymentSettingsAndHomeownerLimits")]
    partial class AddPaymentSettingsAndHomeownerLimits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 31, 13, 28, 1, 12, DateTimeKind.Utc).AddTicks(4985),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 31, 13, 28, 1, 12, DateTimeKind.Utc).AddTicks(5001),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 31, 13, 28, 1, 12, DateTimeKind.Utc).AddTicks(5008),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
