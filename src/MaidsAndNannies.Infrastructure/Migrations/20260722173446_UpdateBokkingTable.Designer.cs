...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260722173446_UpdateBokkingTable")]
    partial class UpdateBokkingTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<string>("OriginalWorkerId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("MaidsAndNannies.Domain.Entities.Identity.ApplicationUser", "OriginalWorker")
                        .WithMany()
                        .HasForeignKey("OriginalWorkerId1")
