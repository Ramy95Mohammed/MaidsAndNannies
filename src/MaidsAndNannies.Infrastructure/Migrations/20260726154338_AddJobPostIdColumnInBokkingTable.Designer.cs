...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260726154338_AddJobPostIdColumnInBokkingTable")]
    partial class AddJobPostIdColumnInBokkingTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 43, 32, 300, DateTimeKind.Utc).AddTicks(8220),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 43, 32, 300, DateTimeKind.Utc).AddTicks(8230),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 43, 32, 300, DateTimeKind.Utc).AddTicks(8242),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
