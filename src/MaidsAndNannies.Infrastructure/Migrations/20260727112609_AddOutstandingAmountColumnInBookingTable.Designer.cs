...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260727112609_AddOutstandingAmountColumnInBookingTable")]
    partial class AddOutstandingAmountColumnInBookingTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 27, 11, 26, 3, 978, DateTimeKind.Utc).AddTicks(9393),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 27, 11, 26, 3, 978, DateTimeKind.Utc).AddTicks(9399),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 27, 11, 26, 3, 978, DateTimeKind.Utc).AddTicks(9406),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
