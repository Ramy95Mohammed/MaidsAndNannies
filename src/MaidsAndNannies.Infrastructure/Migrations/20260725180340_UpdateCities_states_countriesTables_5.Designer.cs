...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260725180340_UpdateCities_states_countriesTables_5")]
    partial class UpdateCities_states_countriesTables_5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 3, 40, 21, DateTimeKind.Utc).AddTicks(5142),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 3, 40, 21, DateTimeKind.Utc).AddTicks(5147),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 3, 40, 21, DateTimeKind.Utc).AddTicks(5151),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
