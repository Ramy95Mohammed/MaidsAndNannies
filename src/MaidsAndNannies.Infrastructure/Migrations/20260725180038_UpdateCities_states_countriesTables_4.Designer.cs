...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260725180038_UpdateCities_states_countriesTables_4")]
    partial class UpdateCities_states_countriesTables_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 0, 36, 965, DateTimeKind.Utc).AddTicks(680),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 0, 36, 965, DateTimeKind.Utc).AddTicks(684),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 18, 0, 36, 965, DateTimeKind.Utc).AddTicks(688),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
