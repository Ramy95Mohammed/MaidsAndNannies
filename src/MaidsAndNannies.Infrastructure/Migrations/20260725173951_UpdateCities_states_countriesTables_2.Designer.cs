...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260725173951_UpdateCities_states_countriesTables_2")]
    partial class UpdateCities_states_countriesTables_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 39, 49, 289, DateTimeKind.Utc).AddTicks(6430),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 39, 49, 289, DateTimeKind.Utc).AddTicks(6435),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 39, 49, 289, DateTimeKind.Utc).AddTicks(6438),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
