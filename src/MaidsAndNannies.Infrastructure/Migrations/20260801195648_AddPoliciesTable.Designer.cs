...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260801195648_AddPoliciesTable")]
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 19, 56, 43, 747, DateTimeKind.Utc).AddTicks(446),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 19, 56, 43, 747, DateTimeKind.Utc).AddTicks(456),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 19, 56, 43, 747, DateTimeKind.Utc).AddTicks(462),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
