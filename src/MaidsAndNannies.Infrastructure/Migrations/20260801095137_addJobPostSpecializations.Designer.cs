...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260801095137_addJobPostSpecializations")]
    partial class addJobPostSpecializations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 9, 51, 33, 229, DateTimeKind.Utc).AddTicks(7826),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 9, 51, 33, 229, DateTimeKind.Utc).AddTicks(7831),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 8, 1, 9, 51, 33, 229, DateTimeKind.Utc).AddTicks(7837),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
