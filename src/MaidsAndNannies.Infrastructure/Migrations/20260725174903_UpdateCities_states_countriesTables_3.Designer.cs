...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260725174903_UpdateCities_states_countriesTables_3")]
    partial class UpdateCities_states_countriesTables_3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 49, 2, 977, DateTimeKind.Utc).AddTicks(6255),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 49, 2, 977, DateTimeKind.Utc).AddTicks(6260),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 25, 17, 49, 2, 977, DateTimeKind.Utc).AddTicks(6264),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
