...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260726182159_AddNationAlityFkInWorkerProfileTable")]
    partial class AddNationAlityFkInWorkerProfileTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 18, 21, 58, 20, DateTimeKind.Utc).AddTicks(5180),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 18, 21, 58, 20, DateTimeKind.Utc).AddTicks(5187),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 18, 21, 58, 20, DateTimeKind.Utc).AddTicks(5192),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
