...
namespace MaidsAndNannies.Infrastructure.Migrations
{
    ...
    [Migration("20260726150458_AddCurrencyIdColumnInJoppostsTable")]
    partial class AddCurrencyIdColumnInJoppostsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaidsAndNannies.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "EGP",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 4, 57, 245, DateTimeKind.Utc).AddTicks(1517),
                            IsActive = true,
                            NameAr = "جنيه مصري",
                        ...
                        new
                        {
                            Id = 2,
                            Code = "USD",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 4, 57, 245, DateTimeKind.Utc).AddTicks(1526),
                            IsActive = true,
                            NameAr = "دولار أمريكي",
                            NameEn = "US Dollar",
                            RateToEgp = 48.5m,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "SAR",
                            CreatedAtUtc = new DateTime(2026, 7, 26, 15, 4, 57, 245, DateTimeKind.Utc).AddTicks(1532),
                            IsActive = true,
                            NameAr = "ريال سعودي",
                            NameEn = "Saudi Riyal",
                            RateToEgp = 12.9m,
